...
const ENEMY_TYPES = [
    ...
    // --- MINIBOSSES ---
    { name: 'Charger', category: 'Miniboss', minLevel: 2, maxHealth: 8, speed: 1.4, color: '#f5e663', img: enemyImgs[5], effect: 'charge' },
    { name: 'Shooter', category: 'Miniboss', minLevel: 3, maxHealth: 9, speed: 0.7, color: '#b5f', img: enemyImgs[1], effect: 'shoot' },
    { name: 'Spitter', category: 'Miniboss', minLevel: 3, maxHealth: 12, speed: 0.8, color: '#0cf', img: enemyImgs[2], effect: 'spit' },
    { name: 'Tank', category: 'Miniboss', minLevel: 2, maxHealth: 10, speed: 0.6, color: '#888', img: enemyImgs[3], effect: 'tank' },
    // NEW MINIBOSSES
    { name: 'Pyro', category: 'Miniboss', minLevel: 4, maxHealth: 18, speed: 0.9, color: '#f80', img: enemyImgs[11], effect: 'fire' },
    { name: 'Frostbite', category: 'Miniboss', minLevel: 5, maxHealth: 20, speed: 1.0, color: '#8cf', img: enemyImgs[12], effect: 'freeze' },
    { name: 'Vampire', category: 'Miniboss', minLevel: 6, maxHealth: 22, speed: 1.1, color: '#c06', img: enemyImgs[3], effect: 'leech' },
    { name: 'Specter', category: 'Miniboss', minLevel: 7, maxHealth: 25, speed: 1.5, color: '#aaa', img: enemyImgs[13], effect: 'phase' },
    { name: 'Bomber', category: 'Miniboss', minLevel: 8, maxHealth: 30, speed: 1.0, color: '#fd0', img: enemyImgs[16], effect: 'bomb' },
    { name: 'Stormling', category: 'Miniboss', minLevel: 9, maxHealth: 40, speed: 1.2, color: '#7cf', img: enemyImgs[17], effect: 'lightning' },

    // --- BOSSES ---
    { name: 'Big Boss', category: 'Boss', minLevel: 2, maxHealth: 22, speed: 0.8, color: '#f33', img: enemyImgs[8], effect: 'bosstears', w: 136, h: 136 },
    { name: 'Twin Boss', category: 'Boss', minLevel: 1, maxHealth: 15, speed: 0.9, color: '#f93', img: enemyImgs[7], effect: 'twin', w: 72, h: 72 },
    { name: 'Summoner', category: 'Boss', minLevel: 3, maxHealth: 18, speed: 0.6, color: '#3cf', img: enemyImgs[10], effect: 'summon', w: 80, h: 80 },
    { name: 'Stormcaller', category: 'Boss', minLevel: 4, maxHealth: 35, speed: 0.7, color: '#7cf', img: enemyImgs[18], effect: 'lightning', w: 88, h: 88 },
    { name: 'Mirror King', category: 'Boss', minLevel: 5, maxHealth: 45, speed: 0.6, color: '#fff', img: enemyImgs[19], effect: 'reflect', w: 100, h: 100 },
    { name: 'Graviton', category: 'Boss', minLevel: 6, maxHealth: 55, speed: 0.5, color: '#aaf', img: enemyImgs[15], effect: 'gravity', w: 110, h: 110 },
    { name: 'Swarm Queen', category: 'Boss', minLevel: 7, maxHealth: 65, speed: 0.8, color: '#fae', img: enemyImgs[4], effect: 'swarm', w: 90, h: 90 },
    { name: 'Time Eater', category: 'Boss', minLevel: 8, maxHealth: 75, speed: 0.7, color: '#9cf', img: enemyImgs[5], effect: 'slow', w: 84, h: 84 },
    // NEW BOSSES
    { name: 'Obliterator', category: 'Boss', minLevel: 5, maxHealth: 40, speed: 0.9, color: '#000', img: enemyImgs[22], effect: 'obliterate', w: 120, h: 120 },
    { name: 'Hydra', category: 'Boss', minLevel: 6, maxHealth: 50, speed: 1.0, color: '#0f8', img: enemyImgs[14], effect: 'multihead', w: 100, h: 100 },
    { name: 'Frost King', category: 'Boss', minLevel: 7, maxHealth: 60, speed: 0.8, color: '#8cf', img: enemyImgs[2], effect: 'freeze', w: 110, h: 110 },
    { name: 'Pyromancer', category: 'Boss', minLevel: 8, maxHealth: 70, speed: 1.1, color: '#f80', img: enemyImgs[23], effect: 'fire', w: 90, h: 90 },
    { name: 'Shadow Lord', category: 'Boss', minLevel: 9, maxHealth: 100, speed: 1.5, color: '#222', img: enemyImgs[20], effect: 'shadow', w: 192, h: 192 },
    { name: 'Demonic Emperor', category: 'Boss', minLevel: 9, maxHealth: 100, speed: 1.5, color: '#7cf', img: enemyImgs[21], effect: 'lightning', w: 198, h: 198 },
];
